package com.praveen.pilani.myspeed;
...
public class Logging extends AppCompatActivity {
	...
	private static final String TAG = "MySpeedLogging";

	private String timeStamp = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss").format(System.currentTimeMillis());
	private String filename = "MySpeed-" + timeStamp + ".csv";
	private String filepath = "MySpeed";
	File envpath;
	File outputFile;
	String outputString = "";
	FileWriter fw;
